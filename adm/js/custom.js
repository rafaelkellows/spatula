$(function() {
	...
	var formVarsToAction = function(b) { 	//Category,Subcategory,Button Action
		if( b.attr('class').indexOf('add_cat') ){ //!c && !s && 
			console.log('Add Category');
		}else{
			if( b.attr('class').indexOf('add_subcat') ){ //!c && !s && 
				console.log('Add Subcategory');
			}else{
				if( b.attr('class').indexOf('edit_cat') ){ //!c && !s && 
					console.log('Edit Category');
				}else{
					if( b.attr('class').indexOf('edit_subcat') ){ //!c && !s && 
						console.log('Edit Subcategory');
					}else{
						if( b.attr('class').indexOf('delete_cat') ){ //!c && !s && 
							console.log('Delete Category');
						}else{
							if( b.attr('class').indexOf('delete_subcat') ){ //!c && !s && 
	...
	var btsFormActions = function() {
		//Add Category
		$('#categoriesForm > div > .add_category').click(function(){
			formVarsToAction(jQuery(this));
		});
		//Add Subcategory
		$('.widgets.categories .actions .add_category').click(function(){
			formVarsToAction(jQuery(this));
		});
	}
	categoriesHover();
	...
	/* Edit Category */
	$('._widgets.categories .actions .edit_category').click(function(e){
		e.preventDefault();
